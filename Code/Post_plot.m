function Post_plot
h  =gcf;      % Post_plot 获得当前figure 句柄，大家需要用这个模板来画图，仔细调整画图规范;下面的参数可以根据具体显示器尺寸就行调整；
dd = get(0,'ScreenSize');

if dd(3)>1500;
    
    MarkerSize=12;  LineWidth =2; LineMethod =1; PlotMethod =1; FontSize=25; FontSize= 25 ; LineWidth = 3;
...
if nargin < 1
    ...
    if dd(3)>1500;
        ...
        LineWidth = 2;TitleFontSize =30; LegendFontSize =36; axis_ratio=2;
        MagRatio =4;
    else
        h = gcf;
        MarkerSize=12; YLabelFontSize =26; FontSize= 26;
        LineWidth = 3;TitleFontSize =26; LegendFontSize =36; axis_ratio=1.5;
        MagRatio=1;
    end
